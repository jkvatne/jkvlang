...
// generateTosOpNos will generate code for the operation op on the two top entries on the stack.
func generateTosOpNos(op Token, val1, val2 *ValueDef) (*ValueDef, error) {
